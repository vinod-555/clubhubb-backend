...
export const registerEvent = async (req, res) => {
  try {
    ...
    console.log(teamSize,eventId);
     // Remove name and email from customizedData if they are present
    const { name, email, collegeName,phoneNumber, ...remainingData } = req.body.additionalInfo;
    ...
    const userFormData = {
      ...
      collegeName:collegeName?collegeName:user.collegeName,
